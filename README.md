...
81 features across routing, cost control, attachments, and conversation management — the full list with how/why each one works is in **[docs/features.md](docs/features.md)**. Headline names, grouped:

**Routing & providers:** AI-based routing · Task-based model selection · Optional budget tier · Zero-cost local models via Ollama · Free-first routing · Multi-provider · Cross-vendor fallback chain · OpenAI-compatible `/v1/chat/completions`
